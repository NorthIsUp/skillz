...
- **Neon** (hosted, external) was the *intended* primary per the original 2026-04-21 design (branching + scale-to-zero), but workloads have since landed on Cloud SQL instead. Whether Neon is still in use at all is unclear — verify before assuming.
