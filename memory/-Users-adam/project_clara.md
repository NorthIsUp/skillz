---
name: project_clara
description: Clara — EHR/medical project at ~/src/teamclara/Clara_V1, exploring Medplum and FHIR for clinical workflows
type: project
...
- Key question: how to surface medication-allergy conflicts using Medplum's APIs

**Why:** Building clinical decision support tooling, likely a POC (has a "clara demo POC" subdirectory).

**How to apply:** When Adam asks about EHR, FHIR, or Medplum topics, this is the project context. Prefer Python-based solutions.
