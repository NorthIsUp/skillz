...
The pattern: every "I need you to do X" should be preceded by "I verified X is not already done." Connects to the existing "verify commands first" memory but extends it: don't just verify command syntax, verify the *premise* of the ask.
