...
description: "Vendored copy of superpowers:brainstorming 6.4.1 (MIT), bundled for plan-critic-build; prefer superpowers:brainstorming when that plugin is installed. You MUST use this before any creative work - creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirements and design before implementation."
---
