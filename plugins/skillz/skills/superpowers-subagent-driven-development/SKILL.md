...
description: "Vendored copy of superpowers:subagent-driven-development 6.4.1 (MIT), bundled for plan-critic-build; prefer superpowers:subagent-driven-development when that plugin is installed. Use when executing implementation plans with independent tasks in the current session"
---
...
digraph process {
    ...
    "Use skillz:superpowers-finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Final review clean: delete this plan's workspace" -> "Use skillz:superpowers-finishing-a-development-branch";
}
```
...
skillz:superpowers-using-git-worktrees to create one or verify the existing one.
...
skillz:superpowers-requesting-code-review's
...
Use skillz:superpowers-finishing-a-development-branch.
...
Done! Using skillz:superpowers-finishing-a-development-branch.
```
