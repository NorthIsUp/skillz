...
description: "Vendored copy of superpowers:writing-plans 6.4.1 (MIT), bundled for plan-critic-build; prefer superpowers:writing-plans when that plugin is installed. Use when you have a spec or requirements for a multi-step task, before touching code"
---
...
**Context:** If working in an isolated worktree, it should have been created via the `skillz:superpowers-using-git-worktrees` skill at execution time.
...
> **For agentic workers:** REQUIRED SUB-SKILL: Use skillz:superpowers-subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **REQUIRED SUB-SKILL:** Use skillz:superpowers-subagent-driven-development
